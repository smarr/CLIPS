...
#define GetIncrementalReset() EnvGetIncrementalReset(GetCurrentEnvironment(),GetCurrentExecutionStatus())
#define SetIncrementalReset(a) EnvSetIncrementalReset(GetCurrentEnvironment(),GetCurrentExecutionStatus(),a)
