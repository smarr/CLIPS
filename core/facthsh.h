...
#define GetFactDuplication() EnvGetFactDuplication(GetCurrentEnvironment(),GetCurrentExecutionStatus())
#define SetFactDuplication(a) EnvSetFactDuplication(GetCurrentEnvironment(),GetCurrentExecutionStatus(),a)
