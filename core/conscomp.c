...
/***************************************/
   ...
   static int                         ConstructsToC(void *,char *,long long,long long);
...
static int ConstructsToC(
  ...
  long long max)
  {
   ...
   gensprintf(fname,"%s_init.c",fileName);
...
globle FILE *NewCFile(
  ...
  int reopenOldFile)
  {
   ...
   gensprintf(fname,"%s%d_%d.c",fileName,id,version);

   if (reopenOldFile)
     { newFP = GenOpen(theEnv,fname,"a"); }
   else
     { newFP = GenOpen(theEnv,fname,"w"); }
