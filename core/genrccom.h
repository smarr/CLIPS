...
#define FindDefgeneric(a) EnvFindDefgeneric(GetCurrentEnvironment(),GetCurrentExecutionStatus(),a)
#define GetDefgenericList(a,b) EnvGetDefgenericList(GetCurrentEnvironment(),GetCurrentExecutionStatus(),a,b)
#define GetDefgenericName(x) GetConstructNameString((struct constructHeader *) x)
#define GetDefgenericPPForm(x) GetConstructPPForm(GetCurrentEnvironment(),GetCurrentExecutionStatus(),(struct constructHeader *) x)
#define GetDefgenericWatch(a) EnvGetDefgenericWatch(GetCurrentEnvironment(),GetCurrentExecutionStatus(),a)
#define GetNextDefgeneric(a) EnvGetNextDefgeneric(GetCurrentEnvironment(),GetCurrentExecutionStatus(),a)
#define IsDefgenericDeletable(a) EnvIsDefgenericDeletable(GetCurrentEnvironment(),GetCurrentExecutionStatus(),a)
#define ListDefgenerics(a,b) EnvListDefgenerics(GetCurrentEnvironment(),GetCurrentExecutionStatus(),a,b)
#define SetDefgenericWatch(a,b) EnvSetDefgenericWatch(GetCurrentEnvironment(),GetCurrentExecutionStatus(),a,b)
#define Undefgeneric(a) EnvUndefgeneric(GetCurrentEnvironment(),GetCurrentExecutionStatus(),a)
#define GetDefmethodDescription(a,b,c,d) EnvGetDefmethodDescription(GetCurrentEnvironment(),GetCurrentExecutionStatus(),a,b,c,d)
#define GetDefmethodList(a,b) EnvGetDefmethodList(GetCurrentEnvironment(),GetCurrentExecutionStatus(),a,b)
#define GetDefmethodPPForm(a,b) EnvGetDefmethodPPForm(GetCurrentEnvironment(),GetCurrentExecutionStatus(),a,b)
#define GetDefmethodWatch(a,b) EnvGetDefmethodWatch(GetCurrentEnvironment(),GetCurrentExecutionStatus(),a,b)
#define GetMethodRestrictions(a,b,c) EnvGetMethodRestrictions(GetCurrentEnvironment(),GetCurrentExecutionStatus(),a,b,c)
#define GetNextDefmethod(a,b) EnvGetNextDefmethod(GetCurrentEnvironment(),GetCurrentExecutionStatus(),a,b)
#define IsDefmethodDeletable(a,b) EnvIsDefmethodDeletable(GetCurrentEnvironment(),GetCurrentExecutionStatus(),a,b)
#define ListDefmethods(a,b) EnvListDefmethods(GetCurrentEnvironment(),GetCurrentExecutionStatus(),a,b)
#define SetDefmethodWatch(a,b,c) EnvSetDefmethodWatch(GetCurrentEnvironment(),GetCurrentExecutionStatus(),a,b,c)
#define Undefmethod(a,b) EnvUndefmethod(GetCurrentEnvironment(),GetCurrentExecutionStatus(),a,b)
