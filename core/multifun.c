...
globle void MultifieldFunctionDefinitions(
  ...
  EXEC_STATUS)
  {
   AllocateEnvironmentData(theEnv,execStatus,MULTIFUN_DATA,sizeof(struct multiFunctionData),NULL);

#if ! RUN_TIME
   EnvDefineFunction2(theEnv,execStatus,"first$", 'm', PTIEF FirstFunction, "FirstFunction", "11m");
   EnvDefineFunction2(theEnv,execStatus,"rest$", 'm', PTIEF RestFunction, "RestFunction", "11m");
   EnvDefineFunction2(theEnv,execStatus,"subseq$", 'm', PTIEF SubseqFunction, "SubseqFunction", "33im");
   EnvDefineFunction2(theEnv,execStatus,"delete-member$", 'm', PTIEF DeleteMemberFunction, "DeleteMemberFunction", "2*um");
   EnvDefineFunction2(theEnv,execStatus,"replace-member$", 'm', PTIEF ReplaceMemberFunction, "ReplaceMemberFunction","3*um");
   EnvDefineFunction2(theEnv,execStatus,"delete$", 'm', PTIEF DeleteFunction, "DeleteFunction", "33im");
   EnvDefineFunction2(theEnv,execStatus,"replace$", 'm', PTIEF ReplaceFunction, "ReplaceFunction","4**mii");
   EnvDefineFunction2(theEnv,execStatus,"insert$", 'm', PTIEF InsertFunction, "InsertFunction", "3**mi");
   EnvDefineFunction2(theEnv,execStatus,"explode$", 'm', PTIEF ExplodeFunction, "ExplodeFunction", "11s");
   EnvDefineFunction2(theEnv,execStatus,"implode$", 's', PTIEF ImplodeFunction, "ImplodeFunction", "11m");
   EnvDefineFunction2(theEnv,execStatus,"nth$", 'u', PTIEF NthFunction, "NthFunction", "22*im");
   EnvDefineFunction2(theEnv,execStatus,"member$", 'u', PTIEF MemberFunction, "MemberFunction", "22*um");
   EnvDefineFunction2(theEnv,execStatus,"subsetp", 'b', PTIEF SubsetpFunction, "SubsetpFunction", "22*mm");
   EnvDefineFunction2(theEnv,execStatus,"progn$", 'u', PTIEF MultifieldPrognFunction, "MultifieldPrognFunction", NULL);
   EnvDefineFunction2(theEnv,execStatus,"foreach", 'u', PTIEF ForeachFunction, "ForeachFunction", NULL);
   EnvDefineFunction2(theEnv,execStatus,"str-implode", 's', PTIEF ImplodeFunction, "ImplodeFunction", "11m");
   EnvDefineFunction2(theEnv,execStatus,"str-explode", 'm', PTIEF ExplodeFunction, "ExplodeFunction", "11s");
   EnvDefineFunction2(theEnv,execStatus,"subset", 'b', PTIEF SubsetpFunction, "SubsetpFunction", "22*mm");
   EnvDefineFunction2(theEnv,execStatus,"nth", 'u', PTIEF NthFunction, "NthFunction", "22*im");
   EnvDefineFunction2(theEnv,execStatus,"mv-replace", 'm', PTIEF MVReplaceFunction, "MVReplaceFunction","33*im");
   EnvDefineFunction2(theEnv,execStatus,"member", 'u', PTIEF MemberFunction, "MemberFunction", "22*um");
   EnvDefineFunction2(theEnv,execStatus,"mv-subseq", 'm', PTIEF MVSubseqFunction, "MVSubseqFunction", "33*iim");
   EnvDefineFunction2(theEnv,execStatus,"mv-delete", 'm', PTIEF MVDeleteFunction,"MVDeleteFunction", "22*im");
#if ! BLOAD_ONLY
   AddFunctionParser(theEnv,execStatus,"progn$",MultifieldPrognParser);
   AddFunctionParser(theEnv,execStatus,"foreach",ForeachParser);
#endif
   FuncSeqOvlFlags(theEnv,execStatus,"progn$",FALSE,FALSE);
   FuncSeqOvlFlags(theEnv,execStatus,"foreach",FALSE,FALSE);
   EnvDefineFunction2(theEnv,execStatus,"(get-progn$-field)", 'u', PTIEF GetMvPrognField, "GetMvPrognField", "00");
   EnvDefineFunction2(theEnv,execStatus,"(get-progn$-index)", 'l', PTIEF GetMvPrognIndex, "GetMvPrognIndex", "00");
#endif
  }
...
globle void DeleteFunction(
  ...
  DATA_OBJECT_PTR returnValue)
  {
   ...
   if ((EnvArgTypeCheck(theEnv,execStatus,"delete$",1,MULTIFIELD,&value1) == FALSE) ||
       (EnvArgTypeCheck(theEnv,execStatus,"delete$",2,INTEGER,&value2) == FALSE) ||
       (EnvArgTypeCheck(theEnv,execStatus,"delete$",3,INTEGER,&value3) == FALSE))
     {
   ...
   if (DeleteMultiValueField(theEnv,execStatus,returnValue,&value1,
...
globle void MVDeleteFunction(
  ...
  DATA_OBJECT_PTR returnValue)
  {
   ...
   if ((EnvArgTypeCheck(theEnv,execStatus,"mv-delete",1,INTEGER,&value1) == FALSE) ||
       (EnvArgTypeCheck(theEnv,execStatus,"mv-delete",2,MULTIFIELD,&value2) == FALSE))
     {
      SetEvaluationError(theEnv,execStatus,TRUE);
      EnvSetMultifieldErrorValue(theEnv,execStatus,returnValue);
      return;
   ...
   if (DeleteMultiValueField(theEnv,execStatus,returnValue,&value2,
...
globle void ReplaceFunction(
  ...
  DATA_OBJECT_PTR returnValue)
  {
   ...
   if ((EnvArgTypeCheck(theEnv,execStatus,"replace$",1,MULTIFIELD,&value1) == FALSE) ||
       (EnvArgTypeCheck(theEnv,execStatus,"replace$",2,INTEGER,&value2) == FALSE) ||
       (EnvArgTypeCheck(theEnv,execStatus,"replace$",3,INTEGER,&value3) == FALSE))
     {
      SetEvaluationError(theEnv,execStatus,TRUE);
      EnvSetMultifieldErrorValue(theEnv,execStatus,returnValue);
      return;
   ...
   if (fieldarg->nextArg != NULL)
     { StoreInMultifield(theEnv,execStatus,&value4,fieldarg,TRUE); }
   else
     { EvaluateExpression(theEnv,execStatus,fieldarg,&value4); }

   /*==============================================*/
   /* Replace the section in the multifield value. */
   /*==============================================*/

   if (ReplaceMultiValueField(theEnv,execStatus,returnValue,&value1,(long) DOToLong(value2),
...
globle void MVReplaceFunction(
  ...
  DATA_OBJECT_PTR returnValue)
  {
   ...
   if ((EnvArgTypeCheck(theEnv,execStatus,"mv-replace",1,INTEGER,&value1) == FALSE) ||
       (EnvArgTypeCheck(theEnv,execStatus,"mv-replace",2,MULTIFIELD,&value2) == FALSE))
     {
      SetEvaluationError(theEnv,execStatus,TRUE);
      EnvSetMultifieldErrorValue(theEnv,execStatus,returnValue);
      return;
   ...
   EvaluateExpression(theEnv,execStatus,GetFirstArgument()->nextArg->nextArg,&value3);

   /*==============================================*/
   /* Replace the section in the multifield value. */
   /*==============================================*/

   if (ReplaceMultiValueField(theEnv,execStatus,returnValue,&value2,(long) DOToLong(value1),
...
globle void DeleteMemberFunction(
  ...
  DATA_OBJECT_PTR returnValue)
  {
   ...
   argCnt = EnvArgCountCheck(theEnv,execStatus,"delete-member$",AT_LEAST,2);
   if (argCnt == -1)
     {
      SetEvaluationError(theEnv,execStatus,TRUE);
      EnvSetMultifieldErrorValue(theEnv,execStatus,returnValue);
   ...
   /* Check for the correct argument types. */
   /*=======================================*/
   if (EnvArgTypeCheck(theEnv,execStatus,"delete-member$",1,MULTIFIELD,&resultValue) == FALSE)
     {
      SetEvaluationError(theEnv,execStatus,TRUE);
      EnvSetMultifieldErrorValue(theEnv,execStatus,returnValue);
      return;
   ...
   delVals = (DATA_OBJECT_PTR) gm2(theEnv,execStatus,delSize);
   for (i = 2 ; i <= argCnt ; i++)
     {
      if (!EnvRtnUnknown(theEnv,execStatus,i,&delVals[i-2]))
        {
         rm(theEnv,execStatus,(void *) delVals,delSize);
         SetEvaluationError(theEnv,execStatus,TRUE);
         EnvSetMultifieldErrorValue(theEnv,execStatus,returnValue);
         return;
        }
   ...
   while (FindDOsInSegment(delVals,argCnt-1,&resultValue,&j,&k,NULL,0))
     {
      if (DeleteMultiValueField(theEnv,execStatus,&tmpVal,&resultValue,
...
globle void ReplaceMemberFunction(
  ...
  DATA_OBJECT_PTR returnValue)
  {
   ...
   /* Check for the correct number of arguments. */
   /*============================================*/
   argCnt = EnvArgCountCheck(theEnv,execStatus,"replace-member$",AT_LEAST,3);
   if (argCnt == -1)
     {
      SetEvaluationError(theEnv,execStatus,TRUE);
      EnvSetMultifieldErrorValue(theEnv,execStatus,returnValue);
   ...
   /* Check for the correct argument types. */
   /*=======================================*/
   if (EnvArgTypeCheck(theEnv,execStatus,"replace-member$",1,MULTIFIELD,&resultValue) == FALSE)
     {
      SetEvaluationError(theEnv,execStatus,TRUE);
      EnvSetMultifieldErrorValue(theEnv,execStatus,returnValue);
      return;
   ...
   if (!EnvRtnUnknown(theEnv,execStatus,2,&replVal))
     {
      SetEvaluationError(theEnv,execStatus,TRUE);
      EnvSetMultifieldErrorValue(theEnv,execStatus,returnValue);
      return;
   ...
   for (i = 3 ; i <= argCnt ; i++)
     {
      if (!EnvRtnUnknown(theEnv,execStatus,i,&delVals[i-3]))
        {
         rm(theEnv,execStatus,(void *) delVals,delSize);
         SetEvaluationError(theEnv,execStatus,TRUE);
         EnvSetMultifieldErrorValue(theEnv,execStatus,returnValue);
   ...
   while (FindDOsInSegment(delVals,argCnt-2,&resultValue,&j,&k,minkp,minkp ? 1 : 0))
     {
      if (ReplaceMultiValueField(theEnv,execStatus,&tmpVal,&resultValue,j,k,
...
globle void InsertFunction(
  ...
  DATA_OBJECT_PTR returnValue)
  {
   ...
   if ((EnvArgTypeCheck(theEnv,execStatus,"insert$",1,MULTIFIELD,&value1) == FALSE) ||
       (EnvArgTypeCheck(theEnv,execStatus,"insert$",2,INTEGER,&value2) == FALSE))
     {
      SetEvaluationError(theEnv,execStatus,TRUE);
      EnvSetMultifieldErrorValue(theEnv,execStatus,returnValue);
      return;
   ...
   if (fieldarg->nextArg != NULL)
     StoreInMultifield(theEnv,execStatus,&value3,fieldarg,TRUE);
   else
     EvaluateExpression(theEnv,execStatus,fieldarg,&value3);

   /*===========================================*/
   /* Insert the value in the multifield value. */
   /*===========================================*/

   if (InsertMultiValueField(theEnv,execStatus,returnValue,&value1,(long) DOToLong(value2), /* TBD */
                             &value3,"insert$") == FALSE)
     {
      SetEvaluationError(theEnv,execStatus,TRUE);
      EnvSetMultifieldErrorValue(theEnv,execStatus,returnValue);
...
globle void ExplodeFunction(
  ...
  DATA_OBJECT_PTR returnValue)
  {
   ...
   if (EnvArgCountCheck(theEnv,execStatus,"explode$",EXACTLY,1) == -1)
     {
   ...
   if (EnvArgTypeCheck(theEnv,execStatus,"explode$",1,STRING,&value) == FALSE)
     {
      SetHaltExecution(theEnv,execStatus,TRUE);
      SetEvaluationError(theEnv,execStatus,TRUE);
      EnvSetMultifieldErrorValue(theEnv,execStatus,returnValue);
   ...
   theMultifield = StringToMultifield(theEnv,execStatus,DOToString(value));
   if (theMultifield == NULL)
     {
      theMultifield = (struct multifield *) EnvCreateMultifield(theEnv,execStatus,0L);
      end = 0;
     }
   else
...
globle void *ImplodeFunction(
  ...
  EXEC_STATUS)
  {
   ...
   if (EnvArgCountCheck(theEnv,execStatus,"implode$",EXACTLY,1) == -1)
     { return(EnvAddSymbol(theEnv,execStatus,"")); }

   /*======================================*/
   /* The argument should be a multifield. */
   /*======================================*/

   if (EnvArgTypeCheck(theEnv,execStatus,"implode$",1,MULTIFIELD,&value) == FALSE)
     { return(EnvAddSymbol(theEnv,execStatus,"")); }
   ...
   return(ImplodeMultifield(theEnv,execStatus,&value));
  }
...
globle void SubseqFunction(
  ...
  DATA_OBJECT_PTR sub_value)
  {
   ...
   if (EnvArgTypeCheck(theEnv,execStatus,"subseq$",1,MULTIFIELD,&value) == FALSE)
     {
      EnvSetMultifieldErrorValue(theEnv,execStatus,sub_value);
      return;
     }
   ...
   if (EnvArgTypeCheck(theEnv,execStatus,"subseq$",2,INTEGER,&value) == FALSE)
     {
      EnvSetMultifieldErrorValue(theEnv,execStatus,sub_value);
      return;
     }
   ...
   if (EnvArgTypeCheck(theEnv,execStatus,"subseq$",3,INTEGER,&value) == FALSE)
     {
      EnvSetMultifieldErrorValue(theEnv,execStatus,sub_value);
      return;
     }
...
globle void MVSubseqFunction(
  ...
  DATA_OBJECT_PTR sub_value)
  {
   ...
   if (EnvArgTypeCheck(theEnv,execStatus,"mv-subseq",1,INTEGER,&value) == FALSE)
     {
      EnvSetMultifieldErrorValue(theEnv,execStatus,sub_value);
      return;
     }
   ...
   if (EnvArgTypeCheck(theEnv,execStatus,"mv-subseq",2,INTEGER,&value) == FALSE)
     {
      EnvSetMultifieldErrorValue(theEnv,execStatus,sub_value);
      return;
     }
   ...
   if (EnvArgTypeCheck(theEnv,execStatus,"mv-subseq",3,MULTIFIELD,&value) == FALSE)
     {
      EnvSetMultifieldErrorValue(theEnv,execStatus,sub_value);
      return;
     }
...
globle void FirstFunction(
  ...
  DATA_OBJECT_PTR returnValue)
  {
   ...
   if (EnvArgTypeCheck(theEnv,execStatus,"first$",1,MULTIFIELD,&theValue) == FALSE)
     {
      EnvSetMultifieldErrorValue(theEnv,execStatus,returnValue);
      return;
     }
...
globle void RestFunction(
  ...
  DATA_OBJECT_PTR returnValue)
  {
   ...
   if (EnvArgTypeCheck(theEnv,execStatus,"rest$",1,MULTIFIELD,&theValue) == FALSE)
     {
      EnvSetMultifieldErrorValue(theEnv,execStatus,returnValue);
      return;
     }
...
globle void NthFunction(
  ...
  DATA_OBJECT_PTR nth_value)
  {
   ...
   if (EnvArgCountCheck(theEnv,execStatus,"nth$",EXACTLY,2) == -1)
	 {
	  SetpType(nth_value,SYMBOL);
	  SetpValue(nth_value,(void *) EnvAddSymbol(theEnv,execStatus,"nil"));
	  return;
	 }

   if ((EnvArgTypeCheck(theEnv,execStatus,"nth$",1,INTEGER,&value1) == FALSE) ||
	   (EnvArgTypeCheck(theEnv,execStatus,"nth$",2,MULTIFIELD,&value2) == FALSE))
	 {
	  SetpType(nth_value,SYMBOL);
	  SetpValue(nth_value,(void *) EnvAddSymbol(theEnv,execStatus,"nil"));
	  return;
...
globle intBool SubsetpFunction(
  ...
  EXEC_STATUS)
  {
   ...
   if (EnvArgCountCheck(theEnv,execStatus,"subsetp",EXACTLY,2) == -1)
     return(FALSE);

   if (EnvArgTypeCheck(theEnv,execStatus,"subsetp",1,MULTIFIELD,&item1) == FALSE)
     return(FALSE);

   if (EnvArgTypeCheck(theEnv,execStatus,"subsetp",2,MULTIFIELD,&item2) == FALSE)
     return(FALSE);
...
globle void MemberFunction(
  ...
  DATA_OBJECT_PTR result)
  {
   ...
   EnvRtnUnknown(theEnv,execStatus,1,&item1);

   if (EnvArgTypeCheck(theEnv,execStatus,"member$",2,MULTIFIELD,&item2) == FALSE) return;
   ...
   if (FindDOsInSegment(&item1,1,&item2,&j,&k,NULL,0))
     {
      if (j == k)
        {
         result->type = INTEGER;
         result->value = (void *) EnvAddLong(theEnv,execStatus,j);
        }
      else
        {
         result->type = MULTIFIELD;
         result->value = EnvCreateMultifield(theEnv,execStatus,2);
         SetMFType(result->value,1,INTEGER);
         SetMFValue(result->value,1,EnvAddLong(theEnv,execStatus,j));
         SetMFType(result->value,2,INTEGER);
         SetMFValue(result->value,2,EnvAddLong(theEnv,execStatus,k));
...
static struct expr *MultifieldPrognParser(
  ...
  char *infile)
  {
   ...
   if (tkn.type != LPAREN)
     {
      top->argList = ParseAtomOrExpression(theEnv,execStatus,infile,&tkn);
      if (top->argList == NULL)
        {
      ...
      if (tkn.type != SF_VARIABLE)
        {
         ...
         top->argList = Function2Parse(theEnv,execStatus,infile,ValueToString(tkn.value));
         if (top->argList == NULL)
           {
            ReturnExpression(theEnv,execStatus,top);
            return(NULL);
   ...
   if (fieldVar != NULL)
     ReplaceMvPrognFieldVars(theEnv,execStatus,fieldVar,top->argList->nextArg,0);
   return(top);

MvPrognParseError:
   SyntaxErrorMessage(theEnv,execStatus,"progn$");
   ReturnExpression(theEnv,execStatus,top);
   return(NULL);
  }
...
ForeachParseError:
   SyntaxErrorMessage(theEnv,execStatus,"foreach");
   ReturnExpression(theEnv,execStatus,top);
   return(NULL);
  }
      ...
      if ((theExp->type != SF_VARIABLE) ? FALSE :
                   ...
                   (STD_SIZE) flen) == 0))
        {
         if (ValueToString(theExp->value)[flen] == '\0')
           {
            theExp->type = FCALL;
            theExp->value = (void *) FindFunction(theEnv,execStatus,"(get-progn$-field)");
           ...
           {
            theExp->type = FCALL;
            theExp->value = (void *) FindFunction(theEnv,execStatus,"(get-progn$-index)");
            theExp->argList = GenConstant(theEnv,execStatus,INTEGER,EnvAddLong(theEnv,execStatus,(long long) depth));
           }
        }
      else if (theExp->argList != NULL)
        {
         if ((theExp->type == FCALL) && ((theExp->value == (void *) FindFunction(theEnv,execStatus,"progn$")) ||
                                        (theExp->value == (void *) FindFunction(theEnv,execStatus,"foreach")) ))
           ReplaceMvPrognFieldVars(theEnv,execStatus,fieldVar,theExp->argList,depth+1);
         else
           ReplaceMvPrognFieldVars(theEnv,execStatus,fieldVar,theExp->argList,depth);
        }
...
globle void MultifieldPrognFunction(
  ...
  DATA_OBJECT_PTR result)
  {
   MultifieldPrognDriver(theEnv,execStatus,result,"progn$");
  }
...
globle void ForeachFunction(
  ...
  DATA_OBJECT_PTR result)
  {
   MultifieldPrognDriver(theEnv,execStatus,result,"foreach");
  }
...
static void MultifieldPrognDriver(
  ...
  char *functionName)
  {
   ...
   ValueInstall(theEnv,execStatus,&argval);
   end = GetDOEnd(argval);
...
globle int ReplaceMultiValueField(
  ...
  char *funcName)
  {
   ...
   if ((re < rb) ||
	   ...
	   (rb > srclen) || (re > srclen))
	 {
	  MVRangeError(theEnv,execStatus,rb,re,srclen,funcName);
	  return(FALSE);
	 }
   rb = src->begin + rb - 1;
   re = src->begin + re - 1;
   ...
   dst->type = MULTIFIELD;
   dst->begin = 0;
   dst->value = EnvCreateMultifield(theEnv,execStatus,dstlen);
...
globle int InsertMultiValueField(
  ...
  char *funcName)
  {
   ...
   if (theIndex < 1)
     {
      MVRangeError(theEnv,execStatus,theIndex,theIndex,srclen+1,funcName);
      return(FALSE);
     }
   ...
   if (src == NULL)
     {
      if (field->type == MULTIFIELD)
        {
         DuplicateMultifield(theEnv,execStatus,dst,field);
         AddToMultifieldList(theEnv,execStatus,(struct multifield *) dst->value);
        }
      else
        {
         dst->value = EnvCreateMultifield(theEnv,execStatus,0L);
         dst->end = 0;
...
static void MVRangeError(
  ...
  char *funcName)
  {
   PrintErrorID(theEnv,execStatus,"MULTIFUN",1,FALSE);
   EnvPrintRouter(theEnv,execStatus,WERROR,"Multifield index ");
   if (brb == bre)
     PrintLongInteger(theEnv,execStatus,WERROR,(long long) brb);
   else
     {
      EnvPrintRouter(theEnv,execStatus,WERROR,"range ");
      PrintLongInteger(theEnv,execStatus,WERROR,(long long) brb);
      EnvPrintRouter(theEnv,execStatus,WERROR,"..");
      PrintLongInteger(theEnv,execStatus,WERROR,(long long) bre);
     }
   EnvPrintRouter(theEnv,execStatus,WERROR," out of range 1..");
   PrintLongInteger(theEnv,execStatus,WERROR,(long long) max);
   if (funcName != NULL)
     {
      EnvPrintRouter(theEnv,execStatus,WERROR," in function ");
      EnvPrintRouter(theEnv,execStatus,WERROR,funcName);
     }
   EnvPrintRouter(theEnv,execStatus,WERROR,".\n");
  }
